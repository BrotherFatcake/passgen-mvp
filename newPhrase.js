...
function newPhraseOptions()    {
    ...
    $('.js-passMagic').html(
        `<p class='newPhrasetitle'>Select your options!</p>
        <br><br>
        ...
        <p class='passOption'><input id='letAnywhere' type='checkbox' value='&whenUp=Anywhere' class='mt20 passCheckbox'>
        <label for='letAnywhere'>Include Random Upper Case</label></p>

        <p class='passOption'><input id='numAnywhere' type='checkbox' value='&whenNum=Anywhere' class='mt20 passCheckbox'>
        <label for='numAnywhere'>Include Random Numbers</label></p>

        <p class='passOption'><input id='noSpace' type='checkbox' value='&sp=false' class='mt20 passCheckbox'>
        <label for='noSpace'>No Spaces</label></p>
       
        </div>

        <div class='createPassCenter js-createPassCenter col-4' role="radiogroup">
        <br>
        <p>Select the number of words to include:</p>  
        <br>
        <p class='numWords'><input type='radio' id='10' name='numWords' value='&wc=10'
        class='mt20 passRadio' role='radio' required>
        <label for='10'> 10 Words </label></p>
        
        <p class='numWords'><input type='radio' id='15' name='numWords' value='&wc=15'
        class='mt20 passRadio' role='radio' required>
        <label for='15'> 15 Words </label></p>

        <p class='numWords'><input type='radio' id='20' name='numWords' value='&wc=20'
        class='mt20 passRadio' role='radio' required>
        <label for='20'> 20 Words </label></p>

        <p class='numWords'><input type='radio' id='25' name='numWords' value='&wc=25'
        class='mt20 passRadio' role='radio' required>
        <label for='25'> 25 Words </label></p>

        <p class='numWords'><input type='radio' id='30' name='numWords' value='&wc=30'
        class='mt20 passRadio' role='radio' required>
        <label for='30'> 30 Words </label></p>

        </div>

        <div class='createPassRight js-createPassRight col-4' role="radiogroup">
        <br>
        <p>Select your passphrase strength:</p>  
        <br>

        <p class='passLength'><input type='radio' id='normal' name='passStrength' value='&s=normal'
        class='mt20 passRadio' role='radio' required>
        <label for='normal'> normal </label></p>

        <p class='passLength'><input type='radio' id='RandomShort' name='passStrength' value='&s=RandomShort'
        class='mt20 passRadio' role='radio' required>
        <label for='RandomShort'> Random Short </label></p>

        <p class='passLength'><input type='radio' id='Strong' name='passStrength' value='&s=Strong'
        class='mt20 passRadio' role='radio' required>
        <label for='Strong'> Strong </label></p>

        <p class='passLength'><input type='radio' id='RandomLong' name='passStrength' value='&s=RandomLong'
        class='mt20 passRadio' role='radio' required>
        <label for='RandomLong'> Random Long </label></p>

        <p class='passLength'><input type='radio' id='RandomForever' name='passStrength' value='&s=RandomForever'
        class='mt20 passRadio' role='radio' required>
