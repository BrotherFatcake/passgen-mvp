...
function newPassOptions()    {
    ...
    $('.js-passMagic').html(
        `<p class='newPassTitle'>Select your options!</p>
        <br><br>
        ...
        <p class='passOption'><input id='upper' type='checkbox' value='upper' class='mt20 passCheckbox' name='charType'>
        <label for='upper'>Upper Case Letters</label></p>

        <p class='passOption'><input id='lower' type='checkbox' value='lower' class='mt20 passCheckbox' name='charType'>
        <label for='lower'>Lower Case Letters</label></p>

        <p class='passOption'><input id='number' type='checkbox' value='number' class='mt20 passCheckbox' name='charType'>
        <label for='number'>Numbers</label></p>
       
        <p class='passOption'><input id='special' type='checkbox' value='special' class='mt20 passCheckbox' name='charType'>
        <label for='special'>Special Characters</label></p>
        </div>

        <div class='createPassRight js-createPassRight col-6' role="radiogroup">
        <br>
